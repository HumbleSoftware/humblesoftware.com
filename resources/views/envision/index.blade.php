...
<div class="demo">
  ...
  <h3><a href="{{$base_url}}envision/demos/realtime " title="HTML5 time series chart with real-time data">Real-Time:</a></h3>

  <div class="image" id="realtime-demo"></div>

  <p>
    TimeSeries template with real-time data.  This demo features animation of 
    the selection when new data arrives.  The data itself is from a function
    but could be a callback to a remote data source.
    <span class="link">
      (<a href="{{$base_url}}envision/demos/realtime" title="HTML5 time series chart with real-time data">click to code</a>)
    </span>
  </p>
...
<div class="demo">
  ...
  <h3><a href="{{$base_url}}envision/demos/timeseries" title="HTML5 time series chart">TimeSeries:</a></h3>
  ...
  <p>
    ...
    <span class="link">
      (<a href="{{$base_url}}envision/demos/timeseries" title="HTML5 time series chart">click to code</a>)
    </span>
  </p>
...
<div class="demo">
  ...
  <h3><a href="{{$base_url}}envision/demos/finance" title="HTML5 Finance Chart">Finance:</a></h3>
  ...
  <p>
    ...
    <span class="link">
      (<a href="{{$base_url}}envision/demos/finance" title="HTML5 Finance Chart">click to code</a>)
    </span>
  </p>
...
<div class="demo">
  ...
  <h3><a href="{{$base_url}}envision/demos/ajax" title="Dynamic HTML5 Finance Chart with Ajax">Ajax:</a></h3>
  ...
  <p>
    ...
    <span class="link">
      (<a href="{{$base_url}}envision/demos/ajax" title="Dynamic HTML5 Finance Chart with Ajax">click to code</a>)
    </span>
  </p>
...
<div class="demo">
  ...
  <h3><a href="{{$base_url}}envision/demos/fractal" title="Custom Example - Fractal">Custom - Fractal:</a></h3>
  ...
  <p>
    ...
    flotr chart type.
    <span class="link">
      (<a href="{{$base_url}}envision/demos/fractal" title="Custom Example - Fractal">click to code</a>)
    </span>
  </p>
