...
<section class="introduction">
  ...
  <p>
    ...
    is rewrite of <a href="{{$base_url}}finance/index" title="HumbleFinance, a library for
  ...
  <ul class="features">
    ...
    <li>Adapted to <a href="{{$base_url}}flotr2" title="Flotr2">Flotr2</a></li>
...
<section class="usage">
  ...
  <ul>
    <li><a href="{{$base_url}}envision/demos/finance" title="HTML5 Finance Chart Template Demo">Finance</a> - An HTML5 finance chart.</li>
    <li><a href="{{$base_url}}envision/demos/timeseries" title="TimeSeries Template Demo">TimeSeries</a> - A summary chart and a detail chart sharing an axis.</li>
  </ul>

  <h4>Template Example (<a href="{{$base_url}}envision/example/template" title="Standalone template example">view standalone</a>)</h4>
  ...
  <p>
    ...
    to the underlying adapter/API (<a href="{{$base_url}}flotr2" title="Flotr2">Flotr2</a> by default).
  </p>

  <h4>Custom Example (<a href="{{$base_url}}envision/example/custom" title="Standalone custom example">view standalone</a>)</h4>
...
<code class="block">var data = [
  ...
  <p>
    ...
    the <a href="{{$base_url}}envision/demos/ajax" title = "Ajax Demo with native Flotr data.">Ajax Demo</a>.
  </p>
...
<section class="development">
  ...
  <section class="api">@include('envision.api')</section>
