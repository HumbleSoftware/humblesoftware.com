...
map <F10> :GitCommit 
map <F9> :GitDiff 
map <F8> :set tabstop=4 shiftwidth=4 
map <F7> :set tabstop=2 shiftwidth=2 
map <F6> :set nonumber! 
map <F5> :set nowrap! 
...
silent only
cd ~/Projects/OpenSource/d3/play/fortune
...
let s:l = 54 - ((12 * winheight(0) + 28) / 57)
